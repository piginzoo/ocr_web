...
# CTPN常用参数
CTPN_MODEL_FILE="" # 定义模型目录，如果FILE被定义，直接加载FILE，否则，挑选最新的模型加载(即在checkpoint文件中记录的）
...
def init_arguments():
    ...
    tf.app.flags.DEFINE_string('pred_home', CTPN_PRED_DIR, '')  # 预测后的结果的输出目录
