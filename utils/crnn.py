...
import utils.crnn.utils.image_util as image_util
...
# # crnn predict
# def predict(image_list, _batch_size):
...
#         preds = data_utils.sparse_tensor_to_str(output_indices, output_values, output_shape, charset)
#         pred_result += preds
